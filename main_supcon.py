...
def parse_option():
    ...
    parser.add_argument('--dataset', type=str, default='VOC', help='dataset')
...
def set_loader(opt):
    ...
    transformed_dataset = PascalVOCDataset(csv_file='objects.csv', transform=TwoCropTransform(operations))
